 ...
 */
public class RainfallViz extends Application {
    ...
    public void start(Stage stage) {
        ...
        BarChart<String, Double> chart = FileLoader();
//        BorderPane root = new BorderPane(canvasHolder);
    ...
    private BarChart<String, Double> FileLoader() {
        int NUM_POINTS = 10;
        Axis<String> xAxis =
        Axis<Double> yAxis =
        BarChart<String, Double> ret =
        for (int i = 0; i < NUM_POINTS; i++) {
            String key = "2021-01-" + (i+1);
